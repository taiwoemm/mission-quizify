...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        # Initialize text_splitter class
        text_splitter  = CharacterTextSplitter(separator="\n\n", chunk_size=2000, 
                                              chunk_overlap=200,length_function=len,
                                              is_separator_regex=False)
        
        # apply text_splitter class
        texts = text_splitter.create_documents([self.processor.pages[i].page_content 
                                               for i in range(len(self.processor.pages))])
