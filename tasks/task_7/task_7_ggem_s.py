...
class QuizGenerator:
    def __init__(self, topic=None, num_questions=1, vectorstore=None):
        ...
        :param num_questions: An integer repre                                 senting the number of questions to generate for the quiz, up to a maximum of 10.
    ...
    def init_llm(self):
        ...
        if "GOOGLE_APPLICATION_CREDENTIALS" not in os.environ:
            os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "Provide path to Google Application Credential json"
    ...
    def generate_question_with_vectorstore(self):
        ...
        ############# YOUR CODE HERE ############
        # chroma_def = self.vectorstore.create_chroma_collection()
        # retriever_vec = chroma_def.as_retriever()
