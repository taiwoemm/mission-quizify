...
- Task 6: Interactive application to enable users to upload documents, designate a quiz topic, select a number of questions, and subsequently generate a quiz based on the uploaded document contents.
- Task 7: QuizGenerator Class with with a required topic, the number of questions for the quiz, an optional vectorstore, and Large Language Model (LLM) for quiz question generation.
